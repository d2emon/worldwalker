DATA = {
    ...
    'nm3': [
        ...
        "hidden high atop a mountain among a layer of clouds", "part of long forgotten ruins", "revealed only by fire",
        "revealed only during a full moon", "revealed only with the right elements",
    ...
    'nm7': [
        ...
        "Perfect conditions in a perfect world", "Much remains to be discovered here",
        "It's a world of hidden mysteries", "Who knows what secrets this world holds",
        "Uncharted territory as far as the eye can see", "There's so much to learn in this world"
    ],
    'nm8': [
        ...
        " you don't feel a sense of dread or danger", " you feel like you're constantly in danger",
        ...
        " and a sea of time to explore it in", ", but not everything that's hidden may be as pleasant as this world",
