...
class Movement:
    ...
    # "venture", "walk"
    movements = [
        "продвигаетесь вперед", "осторожно выходите", "продвигаетесь", "идете", "двигаетесь", "проходите",
        "продвигаетесь", "проходите", "шагаете", "крадетесь", "путешествуете", "выходите", "идете",
    ]
...
class Portal:
    portal_types = [
        ...
        "зовущий", "подвижный", "манящий", "блестящий", "широкий", "темный", "тонкий", "жуткий", "заманчивый",
        "тусклый", "слабый", "знакомый", "яркий", "сверкающий", "большой", "мрачный", "здоровенный", "впечатляющий",
        "светящийся", "живой", "грозный", "узкий", "свежесозданный", "зловещий", "приятный", "призматический",
        "странный", "временный", "заманчивый", "незнакомый", "неизученный", "вибрирующий", "энергетический", "яркий",
        "слабый"
    ]
    descriptions = [
        ...
        "спрятанный среди деревьев", "запертый в заброшенном подвале", "расположенный в этом священном храме",
        "расположенный в этой опустошеной крепости", "расположенный под охраной в этой комнате",
        "являющийся частью большого алтаря", "который когда-то выглядел как обычная дверь", "спрятанный за водопадом",
        "находящийся в конце длинной системы пещер", "находящийся на вершине потухшего вулкана",
        "скрытый в переулке у всех на виду", "образованный двумя изогнутыми деревьями",
        "который раньше выглядел как маленький пруд", "расположенный на вершине пирамиды",
        "напоминающий звездные врата", "напоминающий костер", "расположенный в конце коридора",
        "замаскированный под вход в пещеру", "скрытый слоем облаков на вершине высокой горы",
        "являющийся частью давно забытых руин", "который можно открыть только огнем",
        "который можно обнаружить только в полнолуние", "который можно обнаружить только с правильными элементами",
        "который раньше был заблокирован сложными замками и ловушками", "скрытый у всех на виду в общественном парке"
    ]
...
class World:
    world_types = [
        ...
        # "an ominous",
        "гнетущий", "неуютный", "тревожный", "полный неприятных предчуствий", "пугающий", "мрачный", "враждебный",
        "полный разочарования", "зловещий", "давящий", "неприятный", "вызывающий тревогу", "беспокойный",
        "негостеприимный", "зловещий",

        # "a bustling", "a captivating", "a charming", "a dynamic", "a fascinating", "a marvelous", "a pleasant",
        # "a surprising", "a vibrant", "a vigorous", "a vivid", "a wonderful", "an enchanting", "an energetic",
        # "an engaging"
        "шумный", "захватывающий", "очаровательный", "динамичный", "захватывающий", "чудесный", "приятный",
        "удивительный", "живой", "энергичный", "яркий", "чудесный", "чарующий", "энергичный", "воодушевляющий"
    ]
    descriptions_bad = [
        ...
        # "With each step you take you slide forward a little more. Ice covers everything, soon it might even cover "
        # "you",
        ...
        # "very little",
        # "The ground beneath your feet is cracked and dry and the air is hot and dusty. You can feel your skin begin "
        # "to sweat and your lungs burn with each breath",
        # "Rocks cover virtually every surface you can see, which makes traversing this landscape tricky and dangerous",

        "Плотный от дыма воздух, мешает вам увидеть что-нибудь дальше нескольких метров",
        "Густой туман висит в воздухе и мешает вам увидеть что-нибудь дальше нескольких метров",
        "Воздух обжигает ваши глаза и кожу, вы кашляете, так как каждый вдох обжигает ваши легкие",
        "Густые темные облака заслоняют любой свет сверху и покрывают землю мрачными тенями",
        "Воздух сухой и горячий, яркий свет ослепляет вас, и вы чувствуете, как ваши легкие обжигает каждый вдох",
        "Воздух неприятно влажный и горячий, что заставляет вас сразу же вспотеть",
        "Гравитация здесь намного сильнее, и вы чувствуете ее все сильнее с каждым шагом. Это утомительно",
        "Первое, что вы видите, это пар от вашего дыхания, замерзший воздух вскоре охлаждает вас до глубины души",
        "Облака пыли наполняют воздух, она жжет глаза и легкие при каждом вдохе и мешает видеть",
        "Земля покрыта небольшими ямками и отметинами, вызванными кислотными дождями, к счастью, дождь пока еще не "
        "идет",
        "Мощный порыв ветра едва не поднимает вас в воздух, а барабанящий дождь замораживает в течение нескольких "
        "минут",
        "Вы по колено в теплой мутной воде. Горячий и влажный воздух, заставляет вас почти сразу же вспотеть",
        "Вы оказались в почти полной темноте, и если бы не эхо вы бы даже не подозревали что находитесь под землей",
        "Легко, как перышко, вы плавно плывете над поверхностью, повиснув в густом смоге, наполняющем воздух",
        "Поихоньку, шаг за шагом вы продвигаетесь вперед. Лед покрывает все, скоро он сможет покрыть даже вас",
        "Вырывающийся из отверстий в земле дым создает толстый слой облаков, который покрывает землю тенью",
        "Земля буквально горит. Огонь сжигает все, что хоть немного живо, а живого здесь осталось очень мало",
        "Земля под ногами сухая и покрыта трешинам, а воздух горячий и пыльный. Вы чувствуете, как ваша кожа "
        "покрывается потом, а ваши легкие обжигает каждый вдох",
        "Камни усыпают практически все пространство, насколько вы можете видеть, что делает путешествие по такой "
        "местности сложным и опасным",
    ]
    descriptions_good = [
        # "Lightning strikes close to you and then again and again. The sky roars as an eternal thunder storm "
        # "dominates this realm",
        # "A lush landscape full of color meets your eyes. The air is warm and humid, but pleasantly so",
        # "You gently float above the surface, gravity is not strong here at all. The landscape too tries to reach "
        # "for the sky",
        # "Snowflakes gently glide by, they cover the entire landscape in a thick layer of snow and a silence has "
        # "taken hold of the air",
        # "A luminous world meets your eyes. Everything's glowing in some shape or form, the animals, the plants, "
        # "even some of the rocks",
        # "The first thing you notice is a barrage of scents. Pleasant and calming, this world of scents is unlike "
        # "any other",
        ...
        # "A gentle breeze caresses your face as the rays of a blueish sun warm your skin. It's occasionally blocked "
        # "by a floating island, drifting by",
        ...
        # "Waterfalls pour into the lagoon you're standing in from high above. Light from the orange sun peeks over "
        # "and warms you gently",
        # "A tranquil world welcomes you. Calm, warm and gentle. The lush ground is all the more enticing thanks to "
        # "the stronger gravity pulling you down",
        ...
        # "you've seen before",
        # "You find yourself atop a mountain, watching over a vast jungle-like forest full of never before seen "
        # "plants. "
        ...
        "Молния ударяет рядом с вами, а затем снова и снова. Небо ревет, вечная гроза властвует над этим миром",
        "Вашим глазам открывается яркий, полный цвета пейзаж. Воздух приятно теплый и влажный",
        "Вы плавно плывете над поверхностью, гравитации здесь почти не чувствуется. Окружающий пейзаж кажется тоже "
        "пытается достичь неба",
        "Снежинки мягко летят мимо вас, они покрывают весь пейзаж толстым слоем снега. Воздух охвачен тишиной",
        "Вашим глазам открывается светящийся мир. Все светится в том или ином виде, животные, растения, даже некоторые "
        "камни",
        "Первое, что вы замечаете, это запахи. Приятный и успокаивающий, этот мир ароматов непохож на любой другой",
        "Вы слышите воду, много-много воды. Реки шумят и водопадами падают вниз по склонам гор",
        "Пышные цветочные лепестки летают по ветру, а воздух наполнен звуками невидимых животных",
        "Темный мир встречает вас, но когда ваши глаза приспосабливаются, вы начинаете видеть мир биолюминесценции. "
        "Животные и растения светятся в темноте",
        "Легкий ветерок ласкает ваше лицо, а лучи синеватого солнца согревают вашу кожу. Иногда его закрывает "
        "летающий остров, проплывающий мимо",
        "Свет гигантской луны освещает этот мир и покрывает роскошный пейзаж голубоватым светом",
        "Вы оказались лицом к лицу с огромными статуями, вырезанными из целых гор. Они изображают существ, которых вы "
        "никогда раньше не видели",
        "Водопады вливаются в лагуну, в которой вы стоите, высоко сверху. Свет оранжевого солнца заглядывает в лагуну "
        "и нежно согревает вас",
        "Спокойный мир приветствует вас. Спокойный, теплый и нежный. Мягкая земля манит вас еще сильнее благодаря "
        "сильной гравитации, тянущей вас вниз",
        "Вы чувствуете, что можете подняться над землей благодаря гравитации этого мира. Вы готовитесь исследовать "
        "множество островов, дрейфующих в небе",
        "Умиротворяющий мир приветствует вас. Вас легко касается теплый ветерок дующий из пышных густых лесов перед "
        "вами",
        "Влажная, покрытая травой земля хлюпает под ногами. Этот мир богат жизнью, хотя и совершенно не похожей на ту, "
        "что вы видели раньше",
        "Вы оказываетесь на вершине горы, наблюдая за огромным, похожим на джунгли лесом, полным ранее невиданных "
        "растений. Одни из них гигантские, другие светящиеся, а некоторые даже парят в воздухе",
        "Перед вами обширное пространство огромных гор, со многих из них стекают водопады, которые стекают в "
        "гигантскую реку, которая неспешно течет в вашем направлении",
        "Массивное, странно окрашенное озеро отражает еще более ярко окрашенные горы вдалеке. Здесь тихо и спокойно",
        "Ваш взгляд встречает мир огней и цветов. Тысячи цветов и других форм жизни, кажется, светятся под зеленоватым "
        "солнцем этого мира",
    ]
    descriptions = [
        ...
        # "A sense of calm takes hold of you. Perhaps this world is what you were looking for or maybe something in "
        # "the air is affecting your mind",
        # "You have to keep reminding yourself to not let this astonishing world lull you into a false sense of "
        # "security",
        ...
        "Ужасная вонь заполняет ваши ноздри, и вы сразу начинаете чувствовать тошноту",
        "Это, конечно, не самый приятный для жизни мир, хотя некоторых существ он, кажется, вполне устраивает",
        "Эта местность коварна для путешественника. Кто знает, какие опасности ожидают того кто рискнет отправиться в "
        "путь",
        "Мир полный возможностей ждет, но так же он может быть полон возможных опасностей и смерти",
        "Кто знает, как долго вы сможете продержаться в этом мире, вероятно, недолго",
        "Странная энергия висит в воздухе, от нее у вас по телу бегут мурашки",
        "Низкие, зловещие звуки слышны вдалеке, ну, по крайней мере, вы надеетесь, что вдалеке",
        "Вокруг вас слышны крики и визг, но их источник найти невозможно",
        "Вокруг вас слышны звуки густых пузырьков, вырывающихся из какой-то вязкой грязи или жидкости",
        "Вы могли бы поклясться, что что-то коснулось вашей ноги прямо сейчас, возможно, чтобы изучить вас или "
        "попробовать на вкус",
        "Неизвестность окружает вас, и это не волнующая неизвестность требущая исследования, а ужасный страх",
        "Вы чувствуете, что за вами наблюдают, хотя вы ничего не видите",
        "Игра света и тени на незнакомом пейзаже заставляют работать фантазию",
        "Что-то в воздухе меняет ваш разум, но, по крайней мере, делает этот мир более приятным",
        "Трудно смириться с такими суровыми условиями, но здесь так много нового ждет чтобы вы смогли увидеть",
        "И все же есть что-то странно прекрасное в этом изолированном мире смятения",
        "Сзади вас раздаются странные звуки, возможно, два существа сражаются друг с другом или разрушается окружающая "
        "местность",
        "Ваш первое желание - поискать убежище, чтобы как-то укрыться от этой атмосферы",
        "Вы чувствуете тошноту, должно быть из-за чего-то в воздухе, но кто знает, из-за чего",
        "Каждый ваш шаг дается с огромным трудом, этот мир явно не предназначен для вас",
        "Волна ностальгии нахлынула на вас, вы чувствуешь себя как дома в этом странном мире",
        "Любые страхи, которые у вас были до входа на портал, теперь смыты этим спокойным миром",
        "Чувство спокойствия берет верх, когда вы осматриваете великолепные виды этого мира",
        "Зов приключений овладевает вами. Этот мир богат возможностями",
        "Сразу же ваш разум начинает задаваться вопросами, вроде того, что находится за этим холмом или кто живет на "
        "этом извилистом дереве",
        "Вы не можете не задаться вопросом, кто или что населяет этот мир, и вы никак не можете дождаться ответа на "
        "этот вопрос",
        "Вы ощущаете свободу, вы можете свободно исследовать, что живет в этой реке, что скрывается в этой пещере или "
        "где заканчивается этот лес",
        "Этот мир полон жизнью, звуки всевозможных существ а, возможно, и самой земли наполняет воздух",
        "Жизнь здесь не похожа на ту, к которой вы привыкли. Другиее цвета, другиее ароматы, но все очень приятные",
        "Новый мир буквально открыл вам огромные пространства для новой жизни, готовые для того, чтобы изучить их. Вы "
        "не можете больше ждать",
        "Чувства переполняют вас, вы начинаете чувствовать каждый элемент этого мира",
        "Кажется, этот мир успокаивается. Так ли это на самом деле или просто показалось еще неизвестно, но пока вы "
        "надеетесь",
        "Этот мир отличается от вашего родного, заметно отличается. Но, несмотря на различия, он кажется знакомым",
        "Чувство облегчения берет верх, когда вы понимаете, что этот мир может быть безопасным в дальнейшем",
        "Вы знаете, что прошло совсем немного времени, но этот мир кажется очень многообещающим. Приятным и, похоже, "
        "дружественным",
        "Лучше идти осторожно, ведь все таки это новый мир, но пока все хорошо",
        "Чувство спокойствия овладевает вами. Возможно, этот мир - именно то, что вы искали, или, может быть, что-то в "
        "этом воздухе влияет на ваш разум",
        "Вы должны постоянно напоминать себе, чтобы не позволить этому удивительному миру усыпить вас ложным чувством "
        "безопасности",
        "Это мир нахходится за пределами всего, что вы себе представляли. В каждом его уголке есть красота, в каждый "
        "мгновении - спокойствие",
        "Вы задаетесь вопросом, можете ли вы доверять своим чувствам, ведь мир не может быть таким приятным, как этот",
    ]
    nm7 = [
...
class Realm:
    ...
    nm17 = ["aquatic", "bulky", "chunky", "crawling", "enormous", "feathered", "fluffy", "flying", "gliding", "hairy", "huge", "lean", "muscular", "scaly", "sliding", "slithering", "small", "thin", "tiny"]
