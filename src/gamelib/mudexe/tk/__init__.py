...
"""
from .dummies import fflush, flock, fileno, LOCK_UN
from ..blib import getstr
from ..bprintf import bprintf
from ..gamego import crapup
from ..mobile import onlook
from ..new1 import ail_blind
from ..newuaf1 import my_lev
from ..objsys import lisobs, lispeople, fpbns
from ..opensys import openworld, closeworld
from ..parse import brmode, openroom
from ..support import syslog
from ..weather import isdark, showname
from ..zones import lodex
...
def userwrap():
    if fpbns(globme) != -1:
        loseme()
        syslog("System Wrapup exorcised {}".format(globme))
